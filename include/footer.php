            ...
            <div class="row">
                ...
                <div class="col-md">
                    ...
                    <p class="mb-2 Footer_footerContact">Email:<a class="text-decoration-none ps-1"
                            href="javascript:;">help@frameley.com</a></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="d-flex flex-wrap justify-content-center align-items-center flex-column flex-xl-row gap-3">
                ...
                <div
                    ...
                    <p class="mb-0">©
                        <!-- -->2025
                        <!-- --> Framely, Inc. All rights reserved
                    </p><span class="d-none d-sm-block">|</span>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="Login_authWrp">
                        ...
                        <form class="">
                            <div class="mb-4 form-floating"><input placeholder="Email or Mobile number" id="emailInput"
                                    class="form-control" type="text" value="" name="emailOrMobile"><label
                                    for="emailInput">Email or Mobile
                                    number</label></div>
                            <div class="position-relative PasswordInput_passwordWrp mb-3 form-floating">
                                <input placeholder="Password" id="PasswordInput2" class="form-control" type="password"
                                    value="" name="password">
                                <button type="button"
                            ...
                            <form class="">
                                <div class="mb-4 form-floating">
                                    <input placeholder="Email" id="emailInput3" class="form-control" type="text"
                                        value="" name="emailOrMobile">
                                    <label for="emailInput">Email </label>
                                </div>
                                <div class="mb-4 form-floating">
                                    <input placeholder="Mobile number" id="phone" class="form-control" type="text"
                                        value="" name="emailOrMobile">
                                    <label for="phone">Mobile
                                        number</label>
                                </div>
                                <div class="position-relative PasswordInput_passwordWrp mb-3 form-floating">
                                    <input placeholder="Password" id="PasswordInput" class="form-control"
